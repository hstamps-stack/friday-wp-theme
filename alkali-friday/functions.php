	...
	// This theme uses wp_nav_menu() in one location.
		register_nav_menus(
			array(
				...
				'header-menu' => esc_html__( 'Main Menu', 'alkali-friday' )
			)
		);
...
wp_enqueue_script( 'alkali-friday-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js' ,array(),'5.0.1', true);
